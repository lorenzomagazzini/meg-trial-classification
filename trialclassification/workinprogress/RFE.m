...
<meta content="classification/RFE.m · master · c1465333 / Trial-classification" property="og:title">
...
<meta content="https://gitlab.cubric.cf.ac.uk/c1465333/Trial-classification/blob/master/classification/RFE.m" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="classification/RFE.m · master · c1465333 / Trial-classification" property="twitter:title">
...
<title>classification/RFE.m · master · c1465333 / Trial-classification · GitLab</title>
...
<meta name="csrf-token" content="yIVw+5uDQ1xRFSY9VxTimBcMNx5tXVnlRBq+R7B3fRxae6Y0T4OQcwYJ/U5Tq2CoSVN53/sx5TkXmj6ycBkEYA==" />
...
<input type="hidden" name="path" id="path" value="classification/RFE.m" />
<div class="dropdown">
...
<li>
<a href="/c1465333/Trial-classification/blob/master/classification/RFE.m"><strong>RFE.m</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/c1465333/Trial-classification/blame/master/classification/RFE.m">Blame</a><a class="btn" href="/c1465333/Trial-classification/commits/master/classification/RFE.m">History</a><a class="btn js-data-file-blob-permalink-url" href="/c1465333/Trial-classification/blob/3bfe7696603259d091b9be905cc64582c112da1e/classification/RFE.m">Permalink</a></div>
</div>
</div>
...
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;classification/RFE.m&quot;,&quot;gfm&quot;:&quot;`classification/RFE.m`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><i aria-hidden="true" aria-hidden="true" data-hidden="true" class="fa fa-clipboard"></i></button>
<small>
1.64 KB
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;89e701ecc3256a5c4b346d0a5dc07fa3396436fb&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><i aria-hidden="true" aria-hidden="true" data-hidden="true" class="fa fa-clipboard"></i></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/c1465333/Trial-classification/raw/master/classification/RFE.m"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a></div>
<div class="btn-group" role="group"><a class="btn js-edit-blob  btn-sm" href="/c1465333/Trial-classification/edit/master/classification/RFE.m">Edit</a><button name="button" type="submit" class="btn btn-default" data-target="#modal-upload-blob" data-toggle="modal">Replace</button><button name="button" type="submit" class="btn btn-remove" data-target="#modal-remove-blob" data-toggle="modal">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-new" rel="nofollow" data-method="post" href="/c1465333/Trial-classification/blob/master/classification/RFE.m">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/c1465333/Trial-classification/blob/master/classification/RFE.m?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete RFE.m</h3>
</div>
<div class="modal-body">
<form class="form-horizontal js-delete-blob-form js-quick-submit js-requires-input" action="/c1465333/Trial-classification/blob/master/classification/RFE.m" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="aR3/Z5tSaSNQpW1xNQf97M/kFKKMzLUgQi34uzsIkc774ymoT1K6DAe5tgIxuH/ckbtaYxqgCfwRrXhO+2bosg==" /><div class="form-group commit_message-group">
<label class="control-label" for="commit_message-0c91f78af1bb66d000e2819207dca3af">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-0c91f78af1bb66d000e2819207dca3af" class="form-control js-commit-message" placeholder="Delete RFE.m" required="required" rows="3">
Delete RFE.m</textarea>
</div>
</div>
</div>
...
<div class="checkbox">
<label for="create_merge_request-7dc592b91118ef64e7f1723881691b33"><input type="checkbox" name="create_merge_request" id="create_merge_request-7dc592b91118ef64e7f1723881691b33" value="1" class="js-create-merge-request" checked="checked" />
...
<div class="modal-header">
<a class="close" data-dismiss="modal" href="#">×</a>
<h3 class="page-title">Replace RFE.m</h3>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form form-horizontal" data-method="put" action="/c1465333/Trial-classification/update/master/classification/RFE.m" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="wjV10dLk0pf5Jgrm6Di+cEF3aJSG5181h+stPsYO9vRQy6MeBuQBuK460ZXshzxAHygmVRCL4+nUa63LBmCPiA==" /><div class="dropzone">
...
<label class="control-label" for="commit_message-bc00ece673d04e4e0cb838d985c7042d">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-bc00ece673d04e4e0cb838d985c7042d" class="form-control js-commit-message" placeholder="Replace RFE.m" required="required" rows="3">
Replace RFE.m</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="checkbox">
<label for="create_merge_request-5cfbdcfb7e09f4cd0f264fcd8b4cb8b7"><input type="checkbox" name="create_merge_request" id="create_merge_request-5cfbdcfb7e09f4cd0f264fcd8b4cb8b7" value="1" class="js-create-merge-request" checked="checked" />
Start a <strong>new merge request</strong> with these changes
</label></div>
